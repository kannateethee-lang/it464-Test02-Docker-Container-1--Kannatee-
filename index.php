...
$host = '12001'; // แก้ไขให้ตรงกับค่าทีอยู่ใน Docker Compose หรือ .env
$user = 'Kannatee Theecharoen'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
$db   = '12002'; // แก้ไขให้ตรงกับค่าที่อยู่ใน Docker Compose หรือ .env
